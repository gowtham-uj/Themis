...
import {
  StageFields, HealthBanner, useStageHealth, draftFromView, draftToPatch,
...
export default function Models() {
  ...
  return (
    <>
      <PageHead
        title="Models"
        sub="Defaults for every project. A project can override any of these in its own settings. Keys stay in the environment; only the variable name is saved."
      ...
      {stages.map((s) => {
        ...
        return (
          ...
          >
            ...
            <StageFields stage={s.stage} draft={d} inherited={s} onChange={(next) => setDrafts((prev) => ({ ...prev, [s.stage]: next }))} />
